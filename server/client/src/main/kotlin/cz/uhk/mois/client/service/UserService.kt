...
import cz.uhk.mois.client.exception.UserNotFoundException
...
class UserService(
    ...
    fun findUser(userId: Long): Mono<User> =
        userRepository.findById(userId).switchIfEmpty(Mono.error(UserNotFoundException("User not found")))
}